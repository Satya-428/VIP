...
% Last Modified by GUIDE v2.5 04-Mar-2020 12:05:52
...
%% Diabetes Detection based on Iris Image 
...
axes(handles.axes2);
imshow(uint8(F));
title('DCT Transformation Result');
...
title('Iris Segmentation Result');

eyeimage_filename=file;
...
axes(handles.axes4);
imshow(polar_array);
title('Iris Normalization Result');

save('NR.mat','polar_array','F');
